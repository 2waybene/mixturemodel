...
gammamix.draws <- with(gammamix.params, mix.synthetic.facing.gamma(
...
gammamix.fit <- with(gammamix.params, mix.mle(gammamix.draws, 
method="facing.gamma", lower=lower, upper=upper, mix.prob=mix.prob,
